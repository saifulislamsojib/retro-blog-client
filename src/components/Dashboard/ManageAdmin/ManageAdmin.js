...
const ManageAdmin = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://retro-blog-server.vercel.app/admins")
      .then((res) => res.json())
  ...
  const submit = (data) => {
    toast.promise(
      fetch("https://retro-blog-server.vercel.app/addAdmin", {
        method: "POST",
  ...
  return (
    <div className="mt-5">
      ...
      <button
        ...
        className="block ml-auto bg-purple-600 text-white px-5 py-2 rounded-md mr-5 focus:outline-none focus:ring-2 flex"
      >
